...
// 追加すべきコード
const convertedTypes = selectedTypes.map(typeCode => {
  if (typeCode === "本音型") return "本音型";
  if (typeCode === "建前型") return "建前型";
  if (typeCode === "回避型") return "回避型";
  return "不明";
});
...
const honneMap = {
  "すぐ会いたいな〜（笑）": "ずっと我慢してた。早く会いたいよ…",
  "最近お互い忙しいし、落ち着いたらでいいよ": "ほんとは今すぐ会いたいけど、重いって思われたくないし…",
  "また連絡もらえたら嬉しいな": "自分から求めたくない。期待して傷つくくらいなら、待つ方がいい…",
  "久しぶりに遊園地とか行きたいな": "久しぶりに会えるなら恋人らしいデートがしたい",
  "近場でゆっくりでもいいかも？": "本当はちゃんとお出かけしたい。でも、面倒って思われたくない…",
  "そっちに合わせるよ〜": "自分の気持ちを伝えるのが怖い。ワガママって思われたくないし…",
  "せっかくだしお昼から会おう！": "朝から夜まで、一日中一緒にいたいよ",
  "無理しなくていいから、ゆっくり会おう": "本音は早く会いたいけど、無理はさせたくないし…",
