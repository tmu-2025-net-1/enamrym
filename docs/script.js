...
const steps = [
  {
    from: 'left',
    text: 'ようこそ「本音と建前チャット」へ。\nこれは、表向きの会話（建前）と心の声（本音）を交互に体験できる、シミュレーションチャットです。',
    expectsInput: false
  },
  {
    from: 'right',
  ...
  {
    from: 'left',
    text: '今回のストーリー設定：\n「彼女は彼氏が大好き。でも彼氏の気持ちは少し冷めてきていて…」\nそんな、すれ違い始めた2人のLINE風会話を体験します。',
    expectsInput: false
  },
  {
    from: 'right',
    text: 'なんかリアルすぎてドキドキしてきた…',
    expectsInput: false
  },
  { 
    from: 'left', 
  ...
  {
    from: 'left',
    text: (name) => `${name}さん、ようこそ「本音と建前チャット」へ`,
    expectsInput: false
  },
  {
    from: 'left',
...
function appendBubble(text, from) {
  ...
  bubble.classList.add(from === 'right' ? 'bubble-right' : 'bubble-left');
